...
return [
    ...
    'profiles' => [
        'default' => [
            ...
            'toolbar' => 'undo redo removeformat | styles | bold italic blockquote hr | alignjustify alignleft aligncenter alignright | numlist bullist  | forecolor backcolor |image link media table |  outdent indent | rtl ltr |fullscreen',
        ...
        'simple' => [
            'plugins' => 'accordion autoresize codesample directionality advlist link image lists preview pagebreak searchreplace wordcount code fullscreen insertdatetime media table emoticons',
            'toolbar' => 'styles | bold italic blockquote hr | alignjustify alignleft aligncenter alignright | numlist bullist  | forecolor backcolor | link media table ',
            'upload_directory' => null,
        ],
